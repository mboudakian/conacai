...
<body class="pt-5">
  ...
  <header class="w-100 fixed-top mb-5">
    <div class="headerTop">
      <a href="https://enacom.gob.ar" target="_blank" title="Ir al Sitio de Enacom">
        <img src="images/logo_enacom.png" alt="Logo del Enacom" />
      </a>
    </div>
    ...
    <nav class="navbar navbar-expand-lg  navbar-dark bg-indigo mb-5">
      ...
      <div class="collapse navbar-collapse justify-content-center" id="navbarNav">
        <ul class="navbar-nav">
          ...
          <li class="nav-item active">
            <a class="nav-link" href="#">Plenarias</a>
          </li>
  ...
  <section class="portada-novedades mt-5">
    ...
    <div class="logo-portada pt-4 pl-4 pb-3 col-sm-12">
      <img class="img-fluid mt-4" src="images/conacai-logo.PNG" alt="logo conacai">
    </div>
    <div class="container">


      <div class="carousel-novedades">
        <img class="img-fluid mx-auto d-block" src="images/portada.PNG" alt="imagen de portada">
        <div class="row">
      ...
      <div class="row">
        ...
        <article class="col-sm-12 col-md-6 col-lg-3 col-xs-12 mb-4">
          <div class="card h-100 cardcolor">
            <a class="card-title" href=""><img class="card-img-top" src="images/noticiasthumb.PNG" alt=""> </a>
            <div class="card-body d-flex flex-column py-0">
              <a  class="no-underline" href="">
                <h3 class="card-title h3 text-white">Córdoba: el 42% de los adolescentes se vincula con extraños en la web</h3>
              </a>
            </div>
          </div>
        </article>
